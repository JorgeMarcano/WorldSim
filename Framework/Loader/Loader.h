...
typedef Result (*InitializerObject)(void* object, Size objectIndex);
...
Result LoadInitialState(InitializerObject objectInit, InitializerSpace spaceInit, Size objectCount, Size spaceCount);
